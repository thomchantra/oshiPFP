    ...
    <div className="header-bar">
      <div className="header-bar-left">
        <div className="header-bar-title-row">
          <span className="font-title" style={{ color: 'var(--accent-title)' }}>oshiPFP</span>
          <span className="font-param-label" style={{ color: 'var(--accent-dark)', fontSize: 16 }}>v0.2.1</span>
